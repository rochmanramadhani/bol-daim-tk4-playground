...
class MainController extends Controller
{
    ...
    public function quiz($slug)
    {
        $quiz =
            Quiz::whereSlug($slug)
                ...
                ->first() ?? abort(404, 'Quiz tidak ditemukan');
    ...
    public function result(Request $request, $slug)
    {
        ...
        $correct = 0;
        if ($quiz->my_result) {
            abort(404, 'Anda sudah mengikuti quiz ini sebelumnya');
        }
        ...
        return redirect()
            ->route('quiz.detail', $quiz->slug)
            ->withSuccess('Quiz selesai. Skor Anda: ' . $points);
    }
}
