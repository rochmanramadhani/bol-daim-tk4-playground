    ...
    <x-jet-authentication-card>
        ...
        <div x-data="{ recovery: false }">
            <div class="mb-4 text-sm text-gray-600" x-show="! recovery">
                {{ __('Silakan masukkan kode otentikasi yang diberikan oleh aplikasi otentikasi Anda untuk mengonfirmasi akses ke akun Anda.') }}
            </div>

            <div class="mb-4 text-sm text-gray-600" x-show="recovery">
                {{ __('Silakan masukkan salah satu kode pemulihan darurat Anda untuk mengonfirmasi akses ke akun Anda.') }}
            </div>
